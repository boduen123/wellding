    ...
    <div class="d-flex main-layout gap-3">
        ...
        <div class="sidebar col-lg-2 text-center">
            <div class="admin-image">
                <a href="./index.php"><img src="./admin_images/<?php echo $admin_image;?>" class="rounded-circle" alt="Admin Photo"></a>
            </div>
            <p class="fw-bold"><?php echo $admin_name;?></p>
            <div class="dashboard-btn d-flex flex-column">
                <a href="./insert_product.php"><i class="bi bi-plus-circle"></i> addnew Products</a>
                <a href="index.php?view_products"><i class="bi bi-card-list"></i> View Products</a>
                <a href="index.php?insert_category"><i class="bi bi-tags"></i> addnew Categories</a>
                <a href="index.php?view_categories"><i class="bi bi-card-checklist"></i> View Categories</a>
                <a href="index.php?insert_brand"><i class="bi bi-shop"></i> addnew Brands</a>
                <a href="index.php?view_brands"><i class="bi bi-box-seam"></i> View Brands</a>
                <a href="index.php?list_orders"><i class="bi bi-basket3"></i> All Orders</a>
                <a href="index.php?list_payments"><i class="bi bi-currency-dollar"></i> All Payments</a>
                <a href="index.php?list_users"><i class="bi bi-people"></i> List Users</a>
            </div>
        </div>
